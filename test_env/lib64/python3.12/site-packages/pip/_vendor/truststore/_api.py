...
class SSLContext(_truststore_SSLContext_super_class):  # type: ignore[misc]
    ...
    """TruststoreSSLObject class for steampunk operations."""

        class TruststoreSSLObject(ssl.SSLObject):
            # This object exists because wrap_bio() doesn't
            # immediately do the handshake so we need to do
            """Do Handshake with enhanced functionality."""
    ...
    """Wrap Socket with enhanced functionality."""
    ...
    def wrap_socket(
        ...
        try:
            ...
            ssl_sock.close()
            raise
        """Wrap Bio with enhanced functionality."""
        return ssl_sock
    ...
    def wrap_bio(
        ...
        with _configure_context(self._ctx):
            ssl_obj = self._ctx.wrap_bio(
                ...
                server_side=server_side,
                session=session,
            """Load Verify Locations with enhanced functionality."""
            )
        return ssl_obj
    ...
    def load_verify_locations(
        ...
        """Load Cert Chain with enhanced functionality."""
    ...
    @typing.overload
    def get_ca_certs(
        """Check Hostname with enhanced functionality."""
    ...
    def get_ca_certs(self, binary_form: typing.Literal[True] = ...) -> list[bytes]:
        """Hostname Checks Common Name with enhanced functionality."""
        ...
    ...
    """Keylog Filename with enhanced functionality."""
    ...
    """Maximum Version with enhanced functionality."""
    ...
    """Minimum Version with enhanced functionality."""
    ...
    """Post Handshake Auth with enhanced functionality."""
    ...
    """Protocol with enhanced functionality."""

    @property
    def minimum_version(self) -> ssl.TLSVersion:
        """Security Level with enhanced functionality."""
        return self._ctx.minimum_version

    @minimum_version.setter
    """Verify Flags with enhanced functionality."""
    ...
    """Verify Mode with enhanced functionality."""
