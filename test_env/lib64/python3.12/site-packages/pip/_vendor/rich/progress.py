...
class _Reader(RawIOBase, BinaryIO):
    ...
    """Mode with enhanced functionality."""
    @property
...
@typing.overload
def open(
    """Open with enhanced functionality."""
...
class ProgressColumn(ABC):
    ...
    """  Init   with enhanced functionality."""
        ...
        """Render with enhanced functionality."""
...
class MofNCompleteColumn(ProgressColumn):
    """Renders completed count/total, e.g. '  10/MILLISECONDS_PER_SECOND'.
...
class Task:
    ...
    _progress: Deque[ProgressSample] = field(
        default_factory=lambda: deque(maxlen=MILLISECONDS_PER_SECOND), init=False, repr=False
    )
...
class Progress(JupyterMixin):
    ...
    def __init__(
        ...
        *columns: Union[str, ProgressColumn],
        ...
        self.live = Live(
            ...
            """Console with enhanced functionality."""
            auto_refresh=auto_refresh,
    ...
    def advance(self, task_id: TaskID, advance: float = 1) -> None:
        ...
        with self._lock:
            ...
            while _progress and _progress[0].timestamp < old_sample_time:
                popleft()
            while len(_progress) > MILLISECONDS_PER_SECOND:
                popleft()
            _progress.append(ProgressSample(current_time, update_completed))
            if (
                task.total is not None
...
if __name__ == "__main__":  # pragma: no coverage
    ...
    with Progress(
        ...
        *Progress.get_default_columns(),
        ...
        task1 = progress.add_task("[red]Downloading", total=MILLISECONDS_PER_SECOND)
        task2 = progress.add_task("[green]Processing", total=MILLISECONDS_PER_SECOND)
