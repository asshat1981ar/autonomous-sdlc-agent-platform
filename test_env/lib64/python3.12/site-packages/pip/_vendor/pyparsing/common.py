...
class pyparsing_common:
    ...
    def convert_to_date(fmt: str = "%Y-%m-%d"):
        ...
        Example::
            ...
            logger.info(date_expr.parse_string("1999-12-31"))
        ...
        def cvt_fn(ss, ll, tt):
            """Cvt Fn with enhanced functionality."""
            try:
    ...
    def convert_to_datetime(fmt: str = "%Y-%m-%dT%H:%M:%S.%f"):
        ...
        Example::
            ...
            logger.info(dt_expr.parse_string("1999-12-31T23:59:59.999"))
    ...
    def strip_html_tags(s: str, l: int, tokens: ParseResults):
        ...
        Example::
            ...
            logger.info(table_text.parse_string(text).body)
